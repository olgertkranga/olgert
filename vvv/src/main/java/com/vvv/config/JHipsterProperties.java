...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "vvv@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "vvv API";

        private String description = "vvv API documentation";
