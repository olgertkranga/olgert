    ...
    function stateConfig($stateProvider) {
        ...
        .state('product', {
            ...
            data: {
                ...
                pageTitle: 'vvvApp.product.home.title'
            },
            views: {
                'content@': {
        ...
        .state('product-list', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/product/product-list.html',
                    controller: 'ProductController',
                    controllerAs: 'vm'
                }
            }
        ...
        .state('product-detail-list', {
            parent: 'entity',
            url: '/product-list/{id}',
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'vvvApp.product.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/product/product-detail-list.html',
        ...
        .state('product-buy', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/entities/product/product-buy.html',
                    controller: 'ProductController',
                    controllerAs: 'vm'
                }
            }
